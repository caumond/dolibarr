...
/**
 *  \file       	htdocs/custom/hr/establishment/card.php
...
else if ($id)
{
    ...
    if ($result > 0)
    {
        ...
        else
        {
             ...
             * Barre d'actions
             */
            print '<div class="tabsAction"><a class="butAction" href="'.$_SERVER["PHP_SELF"].'?action=edit&id='.$id.'">'.$langs->trans('Modify').'</a></div>';
			print '<div class="tabsAction"><a class="butActionDelete" href="'.$_SERVER["PHP_SELF"].'?action=delete&id='.$id.'">'.$langs->trans('Delete').'</a></div>';
        }
    }
    else
    {
